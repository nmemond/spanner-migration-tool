		...
		},
		{
			...
			expectedSchema: map[string]ddl.CreateTable{
				"Reviews": {
					...
					ColDefs: map[string]ddl.ColumnDef{
						"review_id":     {Name: "review_id", T: ddl.Type{Name: ddl.Int64}, NotNull: true, AutoGen: ddl.AutoGenCol{Name: constants.AUTO_INCREMENT, GenerationType: constants.AUTO_INCREMENT}},
